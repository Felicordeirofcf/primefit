...
export const AuthProvider = ({ children }) => {
  ...
  const register = async (name, email, password) => {
    try {
      ...
      // 2. Inserir dados na tabela public.profiles
      ...
      if (insertError) {
        console.error('Erro ao inserir na tabela profiles:', insertError.message)
        // Mesmo com erro na inserção na tabela profiles, o usuário foi criado no Auth
        // Então retornamos sucesso, mas logamos o erro
        console.warn('Usuário criado no Auth, mas não na tabela profiles')
      }
