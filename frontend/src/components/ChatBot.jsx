...
const ChatBot = ({ type = 'pre-venda' }) => {
  ...
  useEffect(() => {
    // Mensagem de boas-vindas quando o chat abre
    if (isOpen && messages.length === 0) {
      const welcomeMessage = type === 'pre-venda' 
        ? "Olá! Eu sou a Pri, assistente virtual do PrimeFit! 👋 Estou aqui para te ajudar a descobrir como podemos transformar sua jornada de emagrecimento. Qual é o seu principal objetivo?"
        : "Olá! Sou a assistente do PrimeFit. Como posso te ajudar hoje?";
          ...
          <div className="bg-blue-600 text-white p-4 rounded-t-lg flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold">
                {type === 'pre-venda' ? 'Pri - Assistente PrimeFit' : 'Suporte PrimeFit'}
              </span>
            </div>
            <button
