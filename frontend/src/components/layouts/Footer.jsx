      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center">
              <span className="text-2xl font-display font-bold text-white">PrimeFit</span>
            </Link>
            <p className="mt-4 text-gray-400">
              Transforme seu corpo, transforme sua vida. Consultoria especializada em emagrecimento e transformação corporal.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/emagrecimento" className="text-gray-400 hover:text-white transition-colors">
                  Emagrecimento
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <p className="text-center text-gray-400">
            &copy; {new Date().getFullYear()} PrimeFit. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
